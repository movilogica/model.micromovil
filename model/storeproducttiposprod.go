...
// Productos Tipos Prod
type StoreProductTiposProdE struct {
...
func (e StoreProductTiposProdE) MarshalJSON() ([]byte, error) {
...
func (u *StoreProductTiposProdE) GetAll(token string, filter string) ([]*StoreProductTiposProdE, error) {
...
func (u *StoreProductTiposProdE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreProductTiposProdE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreProductTiposProdE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreProductTiposProdE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

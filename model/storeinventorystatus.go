...
// Inventory Status
type StoreInventoryStatusE struct {
	...
	InventoryId   NullInt64  `json:"inventoryid,omitempty"`
...
func (e StoreInventoryStatusE) MarshalJSON() ([]byte, error) {
	return MarshalJSON_Not_Nulls(e)
}

func (e StoreInventoryStatusE) CreatedFormat() string {
...
func (u *StoreInventoryStatusE) GetAll(token string, filter string) ([]*StoreInventoryStatusE, error) {
...
func (u *StoreInventoryStatusE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreInventoryStatusE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreInventoryStatusE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreInventoryStatusE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

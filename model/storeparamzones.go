...
type StoreParamZonesE struct {
	...
	RgbHex        NullString `json:"rgbhex,omitempty"`
...
func (e StoreParamZonesE) MarshalJSON() ([]byte, error) {
...
func (u *StoreParamZonesE) GetAll(token string, filter string) ([]*StoreParamZonesE, error) {
...
func (u *StoreParamZonesE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreParamZonesE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreParamZonesE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreParamZonesE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

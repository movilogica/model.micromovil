...
// Almacenes Zonas
type StoreWarehouseZonesE struct {
	...
	LevelIdFrom    NullString `json:"levelidfrom,omitempty"`
	PositionIdFrom NullString `json:"positionidfrom,omitempty"`
	AreaIdTo       NullString `json:"areaidto,omitempty"`
	AisleIdTo      NullString `json:"aisleidto,omitempty"`
	SectionIdTo    NullString `json:"sectionidto,omitempty"`
	LevelIdTo      NullString `json:"levelidto,omitempty"`
	PositionIdTo   NullString `json:"positionidto,omitempty"`
...
func (e StoreWarehouseZonesE) MarshalJSON() ([]byte, error) {
...
func (u *StoreWarehouseZonesE) GetAll(token string, filter string) ([]*StoreWarehouseZonesE, error) {
...
func (u *StoreWarehouseZonesE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreWarehouseZonesE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreWarehouseZonesE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreWarehouseZonesE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

...
// Reglas de Picking - Cabecera
type StoreRulePickingE struct {
	...
	Zones         []StoreRulePickingZonesE `json:"zones:omitempty"`
}

func (e StoreRulePickingE) MarshalJSON() ([]byte, error) {
...
func (u *StoreRulePickingE) GetAll(token string, filter string) ([]*StoreRulePickingE, error) {
...
func (u *StoreRulePickingE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreRulePickingE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreRulePickingE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreRulePickingE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

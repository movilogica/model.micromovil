...
func (e StoreProductPersE) MarshalJSON() ([]byte, error) {
...
func (u *StoreProductPersE) GetAll(token string, filter string) ([]*StoreProductPersE, error) {
...
func (u *StoreProductPersE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreProductPersE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreProductPersE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreProductPersE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

...
type StoreParamOrderTypeE struct {
	...
	InOut         NullInt32  `json:"in_out,omitempty"`
...
const queryListStoreParamOrderTypeE = `select uniqueid, sede, flag1, flag2, parentid, code, descrip, ordertypeid, activo, estadoreg, total_records from store_param_order_type_list( $1, $2)`

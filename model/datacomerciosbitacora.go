...
// Comercios bitacora
type DataComercioBitacoraE struct {
...
func (e DataComercioBitacoraE) MarshalJSON() ([]byte, error) {
	return MarshalJSON_Not_Nulls(e)
}

const queryListDataComercioBitacora = `select uniqueid, sede, flag1, flag2, fecha, tipomov, subject, username, activo, estadoreg, total_records from data_comercios_bitacora_list( $1, $2)`
const queryLoadDataComercioBitacora = `select * from data_comercios_bitacora_list( $1, $2)`
const querySaveDataComercioBitacora = `SELECT data_comercios_bitacora_save($1, $2, $3)`
...
func (u *DataComercioBitacoraE) GetAll(token string, filter string) ([]*DataComercioBitacoraE, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

	query := queryListDataComercioBitacora
	...
	var lista []*DataComercioBitacoraE

	/// uniqueid, sede, flag1, flag2, fecha, tipomov, subject, username, activo, estadoreg, total_records
	for rows.Next() {

...
type StoreStoresE struct {
	...
	SubTitle      NullString `json:"subtitle,omitempty"`
...
func (e StoreStoresE) MarshalJSON() ([]byte, error) {
...
func (u *StoreStoresE) GetAll(token string, filter string) ([]*StoreStoresE, error) {
...
func (u *StoreStoresE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreStoresE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreStoresE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

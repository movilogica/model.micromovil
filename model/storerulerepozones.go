...
// Reglas de Reposicion - Zonas
type StoreRuleRepoZonesE struct {
	...
	Actions       []*StoreRulePickingActionsE `json:"actions:omitempty"`
}

func (e StoreRuleRepoZonesE) MarshalJSON() ([]byte, error) {
...
func (u *StoreRuleRepoZonesE) GetAll(token string, filter string) ([]*StoreRuleRepoZonesE, error) {
...
func (u *StoreRuleRepoZonesE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreRuleRepoZonesE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreRuleRepoZonesE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreRuleRepoZonesE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

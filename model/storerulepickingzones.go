...
// Reglas de Picking - Zonas
type StoreRulePickingZonesE struct {
...
func (e StoreRulePickingZonesE) MarshalJSON() ([]byte, error) {
...
func (u *StoreRulePickingZonesE) GetAll(token string, filter string) ([]*StoreRulePickingZonesE, error) {
...
func (u *StoreRulePickingZonesE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreRulePickingZonesE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreRulePickingZonesE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreRulePickingZonesE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

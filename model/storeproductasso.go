...
// Productos Associations
type StoreProductAssoE struct {
	...
	Instruction   NullString `json:"instruction,omitempty"`
...
func (e StoreProductAssoE) MarshalJSON() ([]byte, error) {
...
func (u *StoreProductAssoE) GetAll(token string, filter string) ([]*StoreProductAssoE, error) {
...
func (u *StoreProductAssoE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreProductAssoE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreProductAssoE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreProductAssoE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

...
// Reglas de Almacenaje - Cabecera
type StoreRuleStorageE struct {
	...
	Zones         []StoreRuleStorageZonesE `json:"zones:omitempty"`
}

func (e StoreRuleStorageE) MarshalJSON() ([]byte, error) {
...
func (u *StoreRuleStorageE) GetAll(token string, filter string) ([]*StoreRuleStorageE, error) {
...
func (u *StoreRuleStorageE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreRuleStorageE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreRuleStorageE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreRuleStorageE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()

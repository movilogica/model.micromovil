...
// Categoria de Reposicion
type StoreParamCategRepoE struct {
...
func (e StoreParamCategRepoE) MarshalJSON() ([]byte, error) {
...
func (u *StoreParamCategRepoE) GetAll(token string, filter string) ([]*StoreParamCategRepoE, error) {
...
func (u *StoreParamCategRepoE) Update(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
	...
	query := querySaveStoreParamCategRepoE
	stmt, err := db.Prepare(query)
	if err != nil {
		return nil, err
	}
...
func (u *StoreParamCategRepoE) Delete(token string, data string, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *StoreParamCategRepoE) DeleteByID(token string, id int, metricas string) (map[string]any, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
